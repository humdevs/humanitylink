...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: humanitylink.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: humanitylinkd.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 33759 or testnet: 43759)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 33760 or testnet: 43760)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the humanitylink Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single humanitylink process is using the data directory.
